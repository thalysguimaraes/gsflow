...
export default function Page() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div>
        <h1 className="text-4xl font-semibold mb-2">Olá, Fábio</h1>
        <p className="text-sm text-slate-500">Veja um resumo do seu dia com as propostas pendentes de atuação</p>
        </div>
